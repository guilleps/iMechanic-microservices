...
import com.imechanic.backend.order_service.config.filter.JwtTokenValidator;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize.requestMatchers(privateEndpoints()).authenticated()
                        .anyRequest().denyAll())
    ...
    private RequestMatcher privateEndpoints() {
        return new OrRequestMatcher(
                ...
                new AntPathRequestMatcher("/api/mechanic-step/**")
        );
    }
