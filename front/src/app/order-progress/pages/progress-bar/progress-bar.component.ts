...
export class ProgressBarComponent implements OnInit, OnDestroy {
      ...
      this.orderService
        ...
        .subscribe(
          (response) => {
            ...
            // console.log("nuevo paso:", this.currentServiceIndex);
          },
          (error) => {
  ...
  finishOrder2() {
    this.orderService
      ...
      .subscribe(
        (response) => {
          // console.log('Serviciooo terminado:', response);
      ...
      this.orderService
        ...
        .subscribe(
          (response) => {
            ...
            // Verificar si es el ̼ltimo paso a completar
            if (index === pasosRestantes.length - 1) {
